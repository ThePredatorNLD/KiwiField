 ...
 * 
 * FireworkEffectPlayer provides a thread-safe and (reasonably) version independant way to instantly explode a FireworkEffect at a given location. You are welcome to use,
 * redistribute, modify and destroy your own copies of this source with the following conditions:
 * 
...
public class FireworkEffectPlayer {
	 ...
	 * 
	 * @EventHandler public void onPlayerLogin(PlayerLoginEvent event) { fplayer.playFirework(event.getPlayer().getWorld(), event.getPlayer.getLocation(),
